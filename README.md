# docker環境
ref: https://hub.docker.com/r/tiryoh/ros-desktop-vnc  
http://127.0.0.1:6080
```
mkdir -p ~/catkin_ws/src/
git clone https://github.com/airkei/burger_war.git ~/catkin_ws/src/burger_war
cd ~/catkin_ws/src/burger_war
docker build . -t burger_war
docker run -p 6080:80 --shm-size=512m -v ${PWD}:/home/ubuntu/catkin_ws/src/burger_war --name burger_war burger_war
```
---
